...
@SequenceGenerator(name = "userPickGiftCodeEntitySeqGenerator", sequenceName = "s_user_pick_gift_code", allocationSize = 1)
public class UserPickGiftCodeEntity implements BaseEntity<Long>, Serializable {
    @Serial
    private static final long serialVersionUID = 1L;

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "userPickGiftCodeEntitySeqGenerator")
    private Long id;
